...
if (!process.env.USERNAMEAGB || !process.env.PASSWORDAGB) {
  throw new Error("USERNAME or PASSWORD is not defined in .env");
}
const UsernameENV: string = process.env.USERNAMEAGB;
const PasswordENV: string = process.env.PASSWORDAGB;
